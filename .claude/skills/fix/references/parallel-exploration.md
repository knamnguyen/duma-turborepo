...
Task("execute-agent", "Fix Issue A. Claim tasks via TaskUpdate.", "Fix A")
Task("execute-agent", "Fix Issue B. Claim tasks via TaskUpdate.", "Fix B")
```
...
| 2+ independent issues | Task trees per issue + execute-agent subagents |
