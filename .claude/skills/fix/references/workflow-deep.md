...
Use `research-agent` for external knowledge.
...
Use `plan-agent` to create the implementation plan.
...
- Write a concise technical journal entry upon completion
