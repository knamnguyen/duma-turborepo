...
- Pre-landing review (from `git-manager` pipeline)
...
The git-manager workflow calls this workflow at Step 4. Critical findings block the pipeline. Informational findings are included in the PR body.
