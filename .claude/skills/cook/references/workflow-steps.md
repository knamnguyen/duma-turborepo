...
**Interactive/Auto:**
- Spawn multiple `research-agent` subagents in parallel
- Use `/ck:scout ext` or `scout` agent for codebase search
- Keep reports ≤150 lines

**Parallel:**
- Optional: max 2 `research-agent` subagents if complex
...
- Use `plan-agent` with research context
...
- Launch multiple `execute-agent` subagents
