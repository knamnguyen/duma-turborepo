...
├── research/
│   ├── research-agent-XX-report.md
│   └── ...
├── reports/                                  # Plan-scoped reports (session-resolved only)
│   ├── scout-report.md                       # Default reports go to context/reports/
│   ├── research-agent-report.md
│   └── ...
