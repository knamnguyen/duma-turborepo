...
**When to skip:** If provided with research-agent reports, skip this phase.

## Core Activities

### Parallel Research Agents
- Spawn multiple `research-agent` subagents in parallel to investigate different approaches
- Wait for all `research-agent` subagents to report back before proceeding
- Each `research-agent` investigates a specific aspect or approach
